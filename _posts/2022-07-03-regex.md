...
A RegEx is useful if you have a string of text called `string` and you want a list of all the matches of words starting with say `express...`, best practice involves a few steps:
